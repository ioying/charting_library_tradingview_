...
var h=null,h=function(){e.unbindEvent(g,"load",h);c.postMessage.get("widgetReady",{client_id:this.id},function(){var b;c._ready=!0;for(b=c._ready_handlers.length;b--;)c._ready_handlers[b].call(c);c.postMessage.post(g.contentWindow,"initializationFinished");var h=e.gEl(c.id).contentWindow;if(h.Q17)a();else{var d=null,d=function(){a();e.unbindEvent(h,"load",d)};e.bindEvent(h,"load",d)}})};e.bindEvent(g,"load",h)},render:function(){window[this.options.uid]={datafeed:this.options.datafeed,
...
this._innerWindow().Q3,b=a.model().timeScale().m_points.lastTimePointIndex(),a=a.model().mainSeries().data().valueAt(b)[4];return{index:b,price:a}},createOrderLine:function(){var a=this._innerWindow().Q3,b=a._paneWidgets[0]._state;return a.model().createLineTool(b,this._lastBarPoint(),"LineToolOrder")._adapter},createPositionLine:function(){var a=this._innerWindow().Q3,b=a._paneWidgets[0]._state;return a.model().createLineTool(b,this._lastBarPoint(),"LineToolPosition")._adapter},
createExecutionShape:function(){var a=this._innerWindow().Q3,b=a._paneWidgets[0]._state;return a.model().createLineTool(b,this._lastBarPoint(),"LineToolExecution")._adapter},_widgetResizeTimer:null,createButton:function(a){a=a||{};var b=a.align||"left";a=this._innerWindow().headerWidget;b="left"==b?a._$left:a._$right;a=a.createGroup({single:!0}).appendTo(b);a=$('<div class="button"></div>').appendTo(a);this._widgetResizeTimer&&clearTimeout(this._widgetResizeTimer);var c=this.postMessage,
...
this._onWindowResize);delete window[this.options.uid];var a=e.gEl(this.id),b=a.contentWindow.Q6;b&&b.destroy();a.parentNode.removeChild(a)},getVisibleRange:function(a){this._innerWindow().getVisibleRange(a)},setVisibleRange:function(a,b){this._innerWindow().setVisibleRange(a,b)},onAutoSaveNeeded:function(a){this.postMessage.on("onAutoSaveNeeded",a)},onMarkClick:function(a){this.postMessage.on("onMarkClick",a)},onBarMarkClicked:function(a){this.postMessage.on("onMarkClick",a)},onTimescaleMarkClicked:function(a){this.postMessage.on("onTimescaleMarkClick",
a)},onScreenshotReady:function(a){this.postMessage.on("onScreenshotReady",a)},onContextMenu:function(a){this._innerWindow().Q17.subscribe("onContextMenu",function(b){b.callback(a(b.unixtime,b.price))})},onShortcut:function(a,b){this._innerWindow().createShortcutAction(a,b)},onGrayedObjectClicked:function(a){this._innerWindow().Q17.subscribe("onGrayedObjectClicked",a)},refreshMarks:function(){this.postMessage.post(this._innerWindow(),"refreshMarks")},
