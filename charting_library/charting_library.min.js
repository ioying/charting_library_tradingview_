...
var h=null,h=function(){e.unbindEvent(g,"load",h);c.postMessage.get("widgetReady",{client_id:this.id},function(){var b;c._ready=!0;for(b=c._ready_handlers.length;b--;)c._ready_handlers[b].call(c);c.postMessage.post(g.contentWindow,"initializationFinished");var h=e.gEl(c.id).contentWindow;if(h.D17)a();else{var d=null,d=function(){a();e.unbindEvent(h,"load",d)};e.bindEvent(h,"load",d)}})};e.bindEvent(g,"load",h)},render:function(){window[this.options.uid]={datafeed:this.options.datafeed,
